...
namespace IKS
{
    ...
    private:
        enum KinematicClass
        {
            ...
            FOURTH_FITH_INTERSECTING_SECOND_THIRD_INTERSECTING = 0,
            FOURTH_FITH_INTERSECTING_FIRST_SECOND_INTERSECTING = 0,
            FOURTH_FITH_INTERSECTING_FIRST_SECOND_PARALLEL = 0,
            FOURTH_FITH_INTERSECTING_SECOND_THIRD_PARALLEL = 0,
            SPHERICAL_WRIST = 1,
            SPHERICAL_WRIST_FIRST_SECOND_INTERSECTING = 1,
            THIRD_FOURTH_INTERSECTING_SECOND_THIRD_PARALLEL = 0,
            THIRD_FOURTH_INTERSECTING_SECOND_THIRD_PARALLEL_FOURTH_FITH_PARALLEL = 0,
            FIRST_SECOND_THIRD_PARALLEL = 0,
            FIRST_SECOND_THIRD_PARALLEL_FOURTH_FITH_PARALLEL = 0,
            SECOND_THIRD_FOURTH_PARALLEL = 0,
            REVERSED = 7,
            UNKNOWN
        };
