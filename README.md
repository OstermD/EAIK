...
100 equidistant points from this trajectory and try to compute IK solutions. <br>
...
only a finite set of IK solutions to each such point. 
Our method yields solutions accurate up to the expected floating-point precision.
